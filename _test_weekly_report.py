...
# 明細（イン株価→アウト株価・株数=朝シグナルと同じ式・100株単位）
check("4-1 利確明細: 400株 買2,500円→売2,625円 +50,000円",
      "テスト利確 06/29→07/01 400株｜買 2,500円 → 売 2,625円｜**+50,000円**" in desc)
check("4-2 化薬明細: 500株 買2,006円→売2,036円 +15,005円",
      "テスト化薬 07/01→07/03 500株｜買 2,006円 → 売 2,036円｜**+15,005円**" in desc)
check("4-3 BUY合計行: 買付2,003,000→売却2,068,005 ＝+65,005円",
      "💰 買付合計 2,003,000円 → 売却合計 2,068,005円 ＝ **+65,005円**" in desc)
check("4-4 空売り明細: 売建3,000円→買戻2,850円 +45,000円",
      "テスト空売り 06/30→07/02 300株｜売建 3,000円 → 買戻 2,850円｜**+45,000円**" in desc)

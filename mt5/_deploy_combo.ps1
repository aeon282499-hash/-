...
@("InpDemoOnly=false","InpStopBelowBalance=25000","InpGoldOn=true","InpGoldSymbol=GOLD.","InpGoldJpyPer001=50000","InpGoldLotMax=1.00","InpGoldStopUsd=10.0","InpGoldMaxSpread=40","InpGoldHourLon=10","InpGoldMinLon=15","InpGoldHoldMin=15","InpGoldMagic=20260908",
  "InpJpOn=true","InpJpSymbol=JP225Cash","InpJpJpyPerLot=7000","InpJpLotMax=500.0","InpJpEntryHour=15","InpJpExitHour=9","InpJpHoldWeekend=false","InpJpPrevNightFilter=true","InpJpPrevNightMax=0.0","InpJpMondayFree=true","InpJpMaxSpread=20","InpJpMagic=20260909","InpJpAddHour=1","InpJpAddPct=-0.5","InpJpAddMult=1.0","InpUsOn=true","InpUsSymbol=US500Cash","InpUsJpyPer01=25000","InpUsLotMax=50.0","InpUsMaxSpread=150","InpUsMagic=20260913","InpDeOn=true","InpDeSymbol=GER40Cash","InpDeJpyPer01=40000","InpDeLotMax=50.0","InpDeMaxSpread=400","InpDeEntryHour=1","InpDeExitHour=16","InpDeMagic=20260914","InpGxMode=1","InpGxMinBalance=200000","InpGxEntryHourSrv=1","InpGxEntryMinSrv=5","InpGxExitHourSrv=3","InpGxMaxSpread=25","InpGxJpyPer001=20000","InpGxLotMax=0.10","InpGxMagic=20260910") | Set-Content "$d\MQL5\Presets\XMCombo.set" -Encoding Unicode
$ini = "$src\_start.ini"

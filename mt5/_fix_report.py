...
for pid, ds in by_pos.items():
    ...
    rows.append(dict(position_id=str(pid), system=("金" if e.magic == 20260908 else "日経" if e.magic == 20260909 else "US500" if e.magic == 20260913 else "GER40" if e.magic == 20260914 else "金PM" if e.magic == 20260919 else "金昼"), date=jst(e.time).strftime("%Y-%m-%d"),

...
def build() -> dict:
    ...
    sell_watch["crash"] = {
        ...
        "how": "📄紙の観測のみ（実弾では撃たない）。紙の撃ち方＝翌営業日の寄指（表示の値段以上＝前日終値-3%より下で寄ったら撃たない）で空売り → 大引け成行で買い戻す（当日完結）",
        "caveat": "📄紙のみ（2026-09-22 本人決定で実弾から外した）。26年BT(本番条件・1日1本・50万): 玉2,160/年87本・勝率52.3%・PF1.15・26年+199万＝年+8.0万・DD-112万・最悪年-26.4万・勝ち年14/26・年率SR0.41。時代別 01-08 PF0.77 / 09-16 1.12 / 17-21 1.39 / 22-26 1.23。DSR(N=10)0.754＝多重検定を通らない。実弾はフェード・極上・極み売りの3系統だけ。",
    }

...
function viewAbout() {
  ...
  <div class="card">
    <div style="line-height:1.95">
      <div>📋 <b>朝の作戦</b>（寄り前に見る）… <b>今日出す注文を1画面に</b>。実弾3系統（🩳フェード／👑極上／🔻極み売り。💥崩壊は2026-09-22に実弾から外して紙のみ）の「書いてある通りに出す注文」＋当日のTDnet材料（貸借・代金・触れる系統つき）＋明日の決算発表予定＋資金ラダー。上がる/下がるの新しい予想は足していません（検証済みルールの機械的な出力だけ）。</div>
      <div>🔥 <b>場中ライブ</b> … <b>いま資金が来ているテーマ／セクター／銘柄</b>。取引所リアルタイムの現在値・売買代金（立花証券API）を約1分で全銘柄一巡し、届いた瞬間に画面が更新されます（WebSocket）。平日8:58〜15:35の場中だけ流れます。</div>
      <div>🎯 <b>前夜の準備</b>（前夜に見る）… 当日のTDnet材料と明日の決算予定もここ。前夜に配信した「人と注文が集まる」銘柄15本。方向は付けません。ライブが動いている間は「土俵のいま」も出ます。</div>

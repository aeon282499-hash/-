...
function viewAbout() {
  ...
  <div class="card">
    <div style="line-height:1.95">
      <div>📋 <b>朝の作戦</b>（寄り前に見る）… <b>今日出す注文を1画面に</b>。実弾4系統（🩳フェード／💥崩壊／👑極上／🔻極み売り）の「書いてある通りに出す注文」＋当日のTDnet材料（貸借・代金・触れる系統つき）＋明日の決算発表予定＋資金ラダー。上がる/下がるの新しい予想は足していません（検証済みルールの機械的な出力だけ）。</div>

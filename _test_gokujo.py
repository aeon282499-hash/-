# -*- coding: utf-8 -*-
"""_test_gokujo.py — 「スイング極上」(1枠×300万・乗せなし・5日出来高トレンド≤1.09) のテスト（2026-09-05・2026-09-21 本人「ルール通り300万」で300万×1/乗せ停止に更新）。

①screener.calc_vol_trend5 がBT(_bt_kiwami_gokujo_0905.py)と同じ式 ②main.py の極上ファイル生成ロジック(vt5フィルタ→score順)
③shadow_exit.record_signals(gokujo)=専用ファイルのみ・1枠・300万・値がさ1万円 ④配信文面(👑/1銘柄/300万) ⑤週次は買いだけ ⑧勝ち乗せは停止(ADDON_FRAC=0.0・2026-09-21 本玉300万にしたため)

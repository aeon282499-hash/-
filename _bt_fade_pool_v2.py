# -*- coding: utf-8 -*-
"""_bt_fade_pool_v2.py — 売りフェードの検証プールを本番準拠で作り直す（2026-07-31）。
...
CAP, TOV_MIN, STICKY_MIN, GAIN_FLOOR = 500_000, 3e8, 0.05, 5.0
...
D.to_pickle("_fade_pool_v2.pkl")
print(f"[save] _fade_pool_v2.pkl {len(D):,}件 / {D.sig.nunique():,}日 ({D.sig.min()}〜{D.sig.max()})")
